...
var main = function (_component) {
    _inherits$3(main, _component);

    function main() {
        _classCallCheck$4(this, main);

        var _this = _possibleConstructorReturn$3(this, (main.__proto__ || Object.getPrototypeOf(main)).call(this));
        ...
        value: function render() {
            return creatNode$$1(
                ...
                creatNode$$1(
                    ...
                    creatNode$$1("input", { type: "text", onInput: this.log.bind(this) })
                ),
                creatNode$$1(
                    "li",
...
var renderGlobal = initNode(document.querySelector("#app"));
