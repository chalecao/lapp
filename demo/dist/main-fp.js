...
(function () {
  ...
  function reduceChildren(children, vnode) {
    if (isString(vnode) || isNumber(vnode)) {
      ...
      children = [].concat(toConsumableArray$1(children), toConsumableArray$1(vnode.reduce(reduceChildren, [])));
    } else {
      children.push(vnode);
    }
    return children;
  ...
  */
  ...
  var ifBox = function (_component) {
    ...
    function ifBox() {
      ...
      return possibleConstructorReturn$1(this, (ifBox.__proto__ || Object.getPrototypeOf(ifBox)).apply(this, arguments));
    }
  ...
  var forBox = function (_component) {
    ...
    function forBox() {
      ...
      return possibleConstructorReturn$1(this, (forBox.__proto__ || Object.getPrototypeOf(forBox)).apply(this, arguments));
    }

    createClass$1(forBox, [{
      key: 'handlePath',
  ...
  var elseBox = function (_component) {
    ...
    function elseBox() {
      ...
      return possibleConstructorReturn$1(this, (elseBox.__proto__ || Object.getPrototypeOf(elseBox)).apply(this, arguments));
    }

    createClass$1(elseBox, [{
      key: 'render',
      value: function render(_ref) {
        var props = _ref.props,
            children = _ref.children;
